//! \brief lam viec voi file: input.txt gom so phan tu va cac so nguyen duong
//! \detail neu so do la so nguyen to thi tinh tong cac chu so k phai so nguyen to
//!         NGUOC LAI xuat ra -1
//!         du lieu xuat ra luu vao output.txt
